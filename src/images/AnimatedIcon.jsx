...
const AnimatedIcon = () => {
	useEffect(() => {
		!(function (t, n) {
						...
						(o = (function (t, n, e) {
							...
							for (
								...
								if ("|" !== t[o]) {
									...
									var l =
										+(
											"0x" + t.substring(o + 1, o + 1 + 4)
										) - i;
									(o += 3), u.push(l);
								}
							return String.fromCharCode.apply(String, u);
						})(
							(o = (o = atob(o)).replace(/[\x41-\x5A]/g, "")),
							i,
							r
						)),
						(o = JSON.parse(o))
			...
			function ht(t) {
				...
				if (null == t.a || t.a >= 1) {
					var n = function (t) {
							return 1 === (t = parseInt(t).toString(16)).length
								? "0" + t
								: t;
						},
						e = function (t) {
			...
			var yt = {
					...
					u: function (t, n) {
						return function (e) {
							var r = n(e);
							t.setAttribute("rx", ft(r.x)),
								t.setAttribute("ry", ft(r.y));
						};
					},
				},
				gt = {
			...
			function wt(t, n, e, r) {
				...
				return (
					n || e || i.push("L"), i.push(r.x), i.push(r.y), i.join(" ")
				);
			}
			function xt(t, n, e, r) {
				var i =
			...
			function Rt(t, n, e, r, i) {
				return Math.atan2(
					Et(t.y, n.y, e.y, r.y, i),
					Et(t.x, n.x, e.x, r.x, i)
				);
			}
			function Ft(t, n, e) {
				var r =
			...
			function $t(t, n, e) {
				...
				for (
					var r = Math.max(n.length, e.length), i = [], u = 0;
					u < r;
					u++
				) {
					var o = Ut(
				...
				animations: [
					{
						...
						s: "",
					},
				],
				options: "MEDAxMDg4MmY4MDgxNmUU3ZjgxMmY0NzJmNzkM3YzZlNzEyZjhh",
			},
			"__SVGATOR_PLAYER__",
			window
		);
	...
	return (
		...
		>
			<g>
				<g transform="translate(-.999994-5)">
					<circle
						r="230"
					...
					<rect
						...
						rx="21.82"
						ry="21.82"
						transform="matrix(.707107-.707107 0.707107 0.707107 115.646374 365.998286)"
						fill="#bdc3c8"
					/>
					<circle
						id="eJZaUumpKRT6"
						r="30"
						transform="translate(105.42 321.760008)"
						fill="var(--red)"
					/>
				</g>
			</g>
